...
from package.entity.artifact_entity import DataTransformationArtifact, ModelTrainerArtifact
from package.entity.config_entity import ModelTrainerConfig
from package.util.util import load_numpy_array_data,save_object,load_object
from package.entity.model_factory import MetricInfoArtifact, ModelFactory,GridSearchedBestModel
from package.entity.model_factory import evaluate_classification_model



class TravelEstimatorModel:
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            ...
            travel_model = TravelEstimatorModel(preprocessing_object=preprocessing_obj,trained_model_object=model_object)
            logging.info(f"Saving model at path: {trained_model_file_path}")
            save_object(file_path=trained_model_file_path,obj=travel_model)
